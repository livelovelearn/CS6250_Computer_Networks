...
class Topo1(Topo):
    ...
    def __init__(self, n=1, cpu=.1, bw=100, delay=None,
	    ...
	    # Wire receiver
        self.addLink(receiver, s1, port1=0, port2=downlink, **lconfig_eth)
        self.addLink(receiver, s2, port1=1, port2=downlink, **lconfig_wifi)
        self.addLink(receiver, s3, port1=2, port2=downlink, **lconfig_3g)

        # Wire sender
        self.addLink(sender, s1, port1=0, port2=uplink, **lconfig_eth)
        self.addLink(sender, s2, port1=1, port2=uplink, **lconfig_eth)
        self.addLink(sender, s3, port1=2, port2=uplink, **lconfig_eth)
